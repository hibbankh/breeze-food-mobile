...
///
///
///The class name has changed from View due to conflicting name with a built-in class
///
class ViewWrapper<V extends Viewmodel> extends _AbstractView<V> {
...
// helper methods
  SelectorShouldRebuildBuilder _buildShouldRebuildCallback() {
    if (!viewmodel.busy || !_showProgressIndicator) return (_, __) => false;
    return (_, __) => true;
  }
