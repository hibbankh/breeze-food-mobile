...
//   List<Food> _filterMenuByCategory(FoodCategory category, Set<Food> fullMenu) {
//     return fullMenu.where((food) => food.category == category).toList();
//   }

//   List<Widget> getFoodInThisCategory(Set<Food> fullMenu) {
...
//         builder: (_, viewModel) => NestedScrollView(
